...
createIncomingProperty(PageService.prototype, "page", "pageService");

PageService.prototype.init = defaultInitializer; // TODO: move to base class?

PageService.prototype.accessLevel = function(page) {
    return 'readAndWrite';
}
